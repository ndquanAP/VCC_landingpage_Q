...
export const translations = {
  EN: {
    ...
    expert_opinion_3: "The modern facilities and experienced faculty at VCC provide an excellent environment for students to develop both theoretical knowledge and practical skills.",
    ...
    contact_email_address: "vcc@ptit.edu.vn",
    contact_hotline_title: "Hotline",
    contact_hotline_number: "+84 (024) 3854 2308",
    newsletter_title: "Stay Updated",
    newsletter_description: "Subscribe to our newsletter for the latest VCC news and updates.",
  ...
  VN: {
    ...
    // News Section
    news_title: "Tin tức từ chúng tôi!",
    news_and_activities_title: "Tin tức và hoạt động",
    ...
    expert_opinion_3: "Cơ sở vật chất hiện đại và đội ngũ giảng viên giàu kinh nghiệm tại VCC cung cấp môi trường xuất sắc cho sinh viên phát triển cả kiến thức lý thuyết và kỹ năng thực hành.",

    // Testimonials Section
    testimonial_1_name: "TS. Cao Minh Thắng",
    testimonial_1_position: "Giám đốc Viện Công nghệ Thông tin và Truyền thông (CDIT) - PTIT",
    ...
    newsletter_description: "Đăng ký nhận bản tin để cập nhật tin tức và thông tin mới nhất từ VCC.",
